...
- [ ] Explain what a token is used for.
    a user gets a token when they submit the correct login information and gives them access to the protected pages that require the token for authentication.
- [ ] What steps can you take in your web apps to keep your data secure?
- [ ] Describe how web servers work.
  We use Web servers to store our code which allows us to share our web apps around the globe when the user requests it.
